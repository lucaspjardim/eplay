  ...
  return (
    <>
      ...
      <Section title="Sobre o jogo" background="black">
        <p>
          Sobre o jogo Hogwarts Legacy é um RPG de ação imersivo e de mundo
          aberto ambientado no mundo introduzido pela primeira vez nos livros do
          Harry Potter. Embarque em uma jornada por locais novos e familiares
